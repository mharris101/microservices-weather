...
{ 
    ...
    public class WeatherReportAggregator : IWeatherReportAggregator
    {
        ...
        {
            var precipitationServiceProtocol = _weatherDataConfig.PrecipDataProtocol;
            var precipitationServiceHost = _weatherDataConfig.PrecipDataHost;
            var precipitationServicePort = _weatherDataConfig.PrecipDataPort;
